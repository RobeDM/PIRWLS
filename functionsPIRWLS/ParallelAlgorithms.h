...
//double * ParallelCholLinearSystem(double *m1, MKL_INT n1, double *m2,MKL_INT n2,MKL_INT nCores);
//void NNProduct(double *m1,double *m2,MKL_INT n1,MKL_INT n2,MKL_INT n3,double K1,double K2,double *result, MKL_INT nCores);
//void TNNProduct(double *m1,double *m2,MKL_INT n1,MKL_INT n2,MKL_INT n3,double K1,double K2,double *result, MKL_INT nCores);
//void NNTProduct(double *m1,double *m2,MKL_INT n1,MKL_INT n2,MKL_INT n3,double K1,double K2,double *result, MKL_INT nCores);
